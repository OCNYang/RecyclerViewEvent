...
class AdapterDiffCallback(val oldData: List<DiffUtilFruitBean>, val newData: List<DiffUtilFruitBean>) : DiffUtil.Callback() {
     ...
     */
    override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int) = oldData[oldItemPosition].javaClass == newData[newItemPosition].javaClass
